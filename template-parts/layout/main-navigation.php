...
if ( has_nav_menu( 'header_menu' ) && ( ! is_singular() || 'checked' != get_post_meta( $post->ID, 'header_menu_hide', true ) ) ) { ?>
    ...
    <nav id="site-navigation" class="main-navigation serma-<?php root_navigation_main_classes() ?>" itemscope itemtype="http://schema.org/SiteNavigationElement">
...
<?php } else { ?>
    ...
    <nav id="site-navigation" class="main-navigation <?php root_navigation_main_classes() ?> serma-container" style="display: none;"><ul id="header_menu"></ul></nav>

    <div class="serma-container header-separator"></div>
