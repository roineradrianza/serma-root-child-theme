...
function root_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting( 'root_options[social_github]', array(
        'default' => $defaults['social_github'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[social_github]', array(
        'settings' => 'root_options[social_github]',
        'section'  => 'root_modules_social_profiles',
        'label'    => __( 'GitHub', THEME_TEXTDOMAIN ),
    ) );

    $wp_customize->add_setting( 'root_options[social_discord]', array(
        'default' => $defaults['social_discord'],
        'type'    => 'option',
    ) );
    $wp_customize->add_control( 'root_options[social_discord]', array(
        'settings' => 'root_options[social_discord]',
        'section'  => 'root_modules_social_profiles',
