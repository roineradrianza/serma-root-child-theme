    ...
    public function the_rating( $post_id = 0, $show_text = true ) {
        ...
        if ( $show_text ) {
            ...
            if ( $rating_count > 0 ) {
                ...
                $rating_count_text = apply_filters( 'wpshop_rating_count_text', 'calificación' );
                ...
                echo '<div class="star-rating-text"><em>( <strong>' . $rating_count . '</strong> ' . $rating_count_text . ', ' . __( 'promedio', THEME_TEXTDOMAIN ) . ' <strong>' . $rating_value . '</strong> ' . __( 'de', THEME_TEXTDOMAIN ) .' <strong>' . $this->best . '</strong> )</em></div>';

            }

            else {

                echo '<div class="star-rating-text"><em>( ' . __( 'Sin calificaciones aún', THEME_TEXTDOMAIN ) . ' )</em></div>';
